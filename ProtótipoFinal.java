	...
	public static void main(String[] args) {
      ...
      if(loading == 1) {
				...
				System.out.println("Você se encontra na cidade em que nasceu, o dia tão esperado, o dia em que você finalmente receberá a sua Aptidão.\r\n"
						...
						+ "\r\n"
						+ "\r\n"
						+ "Quando se está em combate você deve usar sua aptidão para sentir a defesa do inimigo que se baseia em uma das Operatios, (Operatio são operações matemáticas) entendendo essa Operatio e resolvendo ela você cria uma abertura no inimigo para poder atacá-lo.\r\n"
						+ "\r\n"
	...
	//???
      ...
      if (loading == 5) {
  		...
  		System.out.println("Vocês dois nocautearam todos do grupo.\r\n"
  				...
  				+ "");
  		System.err.println("(1) Quebrar sua guarda e finalizá-la, dizendo que ela não era justa, e reivindicar o bracelete.");
  		System.err.println("(2) Pedir só o bracelete de Math, e deixar a cidade com Division");
      ...
      if (loading==6) {
    	  ...
    	  int numeroErros = 0;
    		...
    		//CONFERIR SE O CÓDIGO ESTÁ CORRETO
